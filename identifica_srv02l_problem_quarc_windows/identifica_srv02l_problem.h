 ...
 */
#ifndef RTW_HEADER_identifica_srv02l_problem_h_
#define RTW_HEADER_identifica_srv02l_problem_h_
#ifndef identifica_srv02l_problem_COMMON_INCLUDES_
# define identifica_srv02l_problem_COMMON_INCLUDES_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* identifica_srv02l_problem_COMMON_INCLUDES_ */

#include "identifica_srv02l_problem_types.h"
...
#define identifica_srv02l_problem_rtModel RT_MODEL_identifica_srv02l_prob
...
typedef struct {
  ...
  real_T InverseAmplifierGainVV_e;     /* '<S6>/Inverse Amplifier  Gain (V//V)' */
  real_T DACBSaturationV_j;            /* '<S6>/DACB Saturation (V)' */
  real_T AmplifierGainVV_h;            /* '<S6>/Amplifier  Gain (V//V)' */
  real_T AmplifierSaturationV_h;       /* '<S6>/Amplifier  Saturation (V)' */
  ...
  real_T StepAmplitude_k;              /* '<Root>/Step Amplitude ' */
} BlockIO_identifica_srv02l_probl;
...
} D_Work_identifica_srv02l_proble;
...
#define rtB                            identifica_srv02l_problem_B
#define BlockIO                        BlockIO_identifica_srv02l_probl
#define rtX                            identifica_srv02l_problem_X
#define ContinuousStates               ContinuousStates_identifica_srv
#define rtP                            identifica_srv02l_problem_P
#define Parameters                     Parameters_identifica_srv02l_pr
#define rtDWork                        identifica_srv02l_problem_DWork
#define D_Work                         D_Work_identifica_srv02l_proble

/* Parameters (auto storage) */
struct Parameters_identifica_srv02l_pr_ {
  ...
  real_T DiscreteTransferFcn_D;        /* Computed Parameter: D
                                        * '<Root>/Discrete Transfer Fcn'
                                        */
  real_T InverseAmplifierGainVV_Gain_k;/* Expression: 1/K_AMP
                                        * '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  real_T DACBSaturationV_UpperSat_f;   /* Expression: VMAX_DAC
                                        * '<S6>/DACB Saturation (V)'
                                        */
  real_T DACBSaturationV_LowerSat_g;   /* Expression: -VMAX_DAC
                                        * '<S6>/DACB Saturation (V)'
                                        */
  real_T AmplifierGainVV_Gain_k;       /* Expression: K_AMP
                                        * '<S6>/Amplifier  Gain (V//V)'
                                        */
  real_T AmplifierSaturationV_UpperSat_d;/* Expression: VMAX_AMP
                                          * '<S6>/Amplifier  Saturation (V)'
                                          */
  real_T AmplifierSaturationV_LowerSat_a;/* Expression: -VMAX_AMP
                                          * '<S6>/Amplifier  Saturation (V)'
                                          */
  real_T StepAmplitude_Gain;           /* Expression: 0.087266
                                        * '<Root>/Step Amplitude '
                                        */
  real_T StepAmplitude_Gain_j;         /* Expression: 0.087266
                                        * '<Root>/Step Amplitude'
                                        */
...
struct RT_MODEL_identifica_srv02l_prob {
  const char_T *path;
...
extern Parameters_identifica_srv02l_pr identifica_srv02l_problem_P;

/* Block signals (auto storage) */
extern BlockIO_identifica_srv02l_probl identifica_srv02l_problem_B;

/* Continuous states (auto storage) */
extern ContinuousStates_identifica_srv identifica_srv02l_problem_X;

/* Block states (auto storage) */
extern D_Work_identifica_srv02l_proble identifica_srv02l_problem_DWork;
...
extern void identifica_srv02l_problem_SetEventsForThisBaseStep(boolean_T
  *eventFlags);
extern void identifica_srv02l_problem_initialize(boolean_T firstTime);
extern void identifica_srv02l_problem_output(int_T tid);
extern void identifica_srv02l_problem_update(int_T tid);
extern void identifica_srv02l_problem_output0(int_T tid);
extern void identifica_srv02l_problem_terminate(void);

/* Real-time Model object */
extern RT_MODEL_identifica_srv02l_prob *identifica_srv02l_problem_M;
 ...
 *
 * '<Root>' : identifica_srv02l_problem
 * '<S1>'   : identifica_srv02l_problem/Manual Switch 1
 * '<S2>'   : identifica_srv02l_problem/SRV02
 * '<S3>'   : identifica_srv02l_problem/SRV02 Modelo Experimental
 * '<S4>'   : identifica_srv02l_problem/SRV02/SRV02-ET
 * '<S5>'   : identifica_srv02l_problem/SRV02/SRV02-ET/Actuator Electrical  Dynamics
 * '<S6>'   : identifica_srv02l_problem/SRV02 Modelo Experimental/Actuator Dynamics
 */
#endif                                 /* RTW_HEADER_identifica_srv02l_problem_h_ */
