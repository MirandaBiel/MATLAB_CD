/*
 * identifica_srv02l_problem_data.c
 *
...
Parameters_identifica_srv02l_pr identifica_srv02l_problem_P = {
  ...
  0.0,                                 /* Integrator_IC : '<S3>/Integrator'
                                        */
  0.4196,                              /* DiscreteTransferFcn_A : '<Root>/Discrete Transfer Fcn'
                                        */
  -1.8677856000000003E+002,            /* DiscreteTransferFcn_C : '<Root>/Discrete Transfer Fcn'
                                        */
  4.164E+002,                          /* DiscreteTransferFcn_D : '<Root>/Discrete Transfer Fcn'
                                        */
  1.0,                                 /* InverseAmplifierGainVV_Gain_k : '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  10.0,                                /* DACBSaturationV_UpperSat_f : '<S6>/DACB Saturation (V)'
                                        */
  -10.0,                               /* DACBSaturationV_LowerSat_g : '<S6>/DACB Saturation (V)'
                                        */
  1.0,                                 /* AmplifierGainVV_Gain_k : '<S6>/Amplifier  Gain (V//V)'
                                        */
  24.0,                                /* AmplifierSaturationV_UpperSat_d : '<S6>/Amplifier  Saturation (V)'
                                        */
  -24.0,                               /* AmplifierSaturationV_LowerSat_a : '<S6>/Amplifier  Saturation (V)'
                                        */
  0.087266,                            /* StepAmplitude_Gain : '<Root>/Step Amplitude '
                                        */
  0.087266,                            /* StepAmplitude_Gain_j : '<Root>/Step Amplitude'
                                        */
