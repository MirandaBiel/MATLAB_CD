...
typedef identifica_srv02l_problem_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * identifica_srv02l_problem(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(identifica_srv02l_problem_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://identifica_srv02l_problem:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: identifica_srv02l_problem -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
        ...
        if (result == 0) {
          result = hil_task_start
            (identifica_srv02l_problem_DWork.HILReadAnalogTimebase_Task,
             identifica_srv02l_problem_P.HILReadAnalogTimebase_Clock, 1000.0, -1)
            ;
          if (result == 0) {
