/*
 * identifica_srv02l_AutomatizaFuncaoDiscreta.h
 *
 ...
 */
#ifndef RTW_HEADER_identifica_srv02l_AutomatizaFuncaoDiscreta_h_
#define RTW_HEADER_identifica_srv02l_AutomatizaFuncaoDiscreta_h_
#ifndef identifica_srv02l_AutomatizaFuncaoDiscreta_COMMON_INCLUDES_
# define identifica_srv02l_AutomatizaFuncaoDiscreta_COMMON_INCLUDES_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* identifica_srv02l_AutomatizaFuncaoDiscreta_COMMON_INCLUDES_ */

#include "identifica_srv02l_AutomatizaFuncaoDiscreta_types.h"
...
#define identifica_srv02l_AutomatizaFuncaoDiscreta_rtModel RT_MODEL_identifica_srv02l_Auto
...
typedef struct {
  ...
  real_T InverseAmplifierGainVV_n;     /* '<S6>/Inverse Amplifier  Gain (V//V)' */
  real_T DACBSaturationV_i;            /* '<S6>/DACB Saturation (V)' */
  real_T AmplifierGainVV_h;            /* '<S6>/Amplifier  Gain (V//V)' */
  ...
  real_T StepAmplitude_l;              /* '<Root>/Step Amplitude ' */
} BlockIO_identifica_srv02l_Autom;
...
} D_Work_identifica_srv02l_Automa;
...
#define rtB                            identifica_srv02l_AutomatizaF_B
#define BlockIO                        BlockIO_identifica_srv02l_Autom
#define rtX                            identifica_srv02l_AutomatizaF_X
#define ContinuousStates               ContinuousStates_identifica_srv
#define rtP                            identifica_srv02l_AutomatizaF_P
#define Parameters                     Parameters_identifica_srv02l_Au
#define rtDWork                        identifica_srv02l_Automat_DWork
#define D_Work                         D_Work_identifica_srv02l_Automa

/* Parameters (auto storage) */
struct Parameters_identifica_srv02l_Au_ {
  ...
  real_T DiscreteZeroPole_D;           /* Computed Parameter: D
                                        * '<Root>/Discrete Zero-Pole'
                                        */
  real_T InverseAmplifierGainVV_Gain_i;/* Expression: 1/K_AMP
                                        * '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  real_T DACBSaturationV_UpperSat_f;   /* Expression: VMAX_DAC
                                        * '<S6>/DACB Saturation (V)'
                                        */
  real_T DACBSaturationV_LowerSat_o;   /* Expression: -VMAX_DAC
                                        * '<S6>/DACB Saturation (V)'
                                        */
  real_T AmplifierGainVV_Gain_n;       /* Expression: K_AMP
                                        * '<S6>/Amplifier  Gain (V//V)'
                                        */
  real_T AmplifierSaturationV_UpperSat_a;/* Expression: VMAX_AMP
                                          * '<S6>/Amplifier  Saturation (V)'
                                          */
  real_T AmplifierSaturationV_LowerSat_e;/* Expression: -VMAX_AMP
                                          * '<S6>/Amplifier  Saturation (V)'
                                          */
  real_T StepAmplitude_Gain;           /* Expression: 0.087266
                                        * '<Root>/Step Amplitude '
                                        */
  real_T StepAmplitude_Gain_h;         /* Expression: 0.087266
                                        * '<Root>/Step Amplitude'
                                        */
...
struct RT_MODEL_identifica_srv02l_Auto {
  const char_T *path;
...
extern Parameters_identifica_srv02l_Au identifica_srv02l_AutomatizaF_P;

/* Block signals (auto storage) */
extern BlockIO_identifica_srv02l_Autom identifica_srv02l_AutomatizaF_B;

/* Continuous states (auto storage) */
extern ContinuousStates_identifica_srv identifica_srv02l_AutomatizaF_X;

/* Block states (auto storage) */
extern D_Work_identifica_srv02l_Automa identifica_srv02l_Automat_DWork;
...
extern void identifica_srv02l_AutomatizaFuncaoDiscreta_SetEventsForThisBaseStep
  (boolean_T *eventFlags);
extern void identifica_srv02l_AutomatizaFuncaoDiscreta_initialize(boolean_T
  firstTime);
extern void identifica_srv02l_AutomatizaFuncaoDiscreta_output(int_T tid);
extern void identifica_srv02l_AutomatizaFuncaoDiscreta_update(int_T tid);
extern void identifica_srv02l_AutomatizaFuncaoDiscreta_output0(int_T tid);
extern void identifica_srv02l_AutomatizaFuncaoDiscreta_terminate(void);

/* Real-time Model object */
extern RT_MODEL_identifica_srv02l_Auto *identifica_srv02l_Automatiza_M;
 ...
 *
 * '<Root>' : identifica_srv02l_AutomatizaFuncaoDiscreta
 * '<S1>'   : identifica_srv02l_AutomatizaFuncaoDiscreta/Manual Switch 1
 * '<S2>'   : identifica_srv02l_AutomatizaFuncaoDiscreta/SRV02
 * '<S3>'   : identifica_srv02l_AutomatizaFuncaoDiscreta/SRV02 Modelo Experimental
 * '<S4>'   : identifica_srv02l_AutomatizaFuncaoDiscreta/SRV02/SRV02-ET
 * '<S5>'   : identifica_srv02l_AutomatizaFuncaoDiscreta/SRV02/SRV02-ET/Actuator Electrical  Dynamics
 * '<S6>'   : identifica_srv02l_AutomatizaFuncaoDiscreta/SRV02 Modelo Experimental/Actuator Dynamics
 */
#endif                                 /* RTW_HEADER_identifica_srv02l_AutomatizaFuncaoDiscreta_h_ */
