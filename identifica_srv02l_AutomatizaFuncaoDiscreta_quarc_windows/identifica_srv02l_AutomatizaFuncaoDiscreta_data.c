/*
 * identifica_srv02l_AutomatizaFuncaoDiscreta_data.c
 *
...
Parameters_identifica_srv02l_Au identifica_srv02l_AutomatizaF_P = {
  ...
  1.0,                                 /* InverseAmplifierGainVV_Gain_i : '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  10.0,                                /* DACBSaturationV_UpperSat_f : '<S6>/DACB Saturation (V)'
                                        */
  -10.0,                               /* DACBSaturationV_LowerSat_o : '<S6>/DACB Saturation (V)'
                                        */
  1.0,                                 /* AmplifierGainVV_Gain_n : '<S6>/Amplifier  Gain (V//V)'
                                        */
  24.0,                                /* AmplifierSaturationV_UpperSat_a : '<S6>/Amplifier  Saturation (V)'
                                        */
  -24.0,                               /* AmplifierSaturationV_LowerSat_e : '<S6>/Amplifier  Saturation (V)'
                                        */
