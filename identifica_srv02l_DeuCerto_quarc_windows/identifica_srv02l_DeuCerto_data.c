/*
 * identifica_srv02l_DeuCerto_data.c
 *
...
Parameters_identifica_srv02l_De identifica_srv02l_DeuCerto_P = {
  ...
  0.0,                                 /* Integrator_IC : '<S3>/Integrator'
                                        */
  4.5627352617447486E-001,             /* DiscreteZeroPole_A : '<Root>/Discrete Zero-Pole'
                                        */
  -1.7006877114773758E+001,            /* DiscreteZeroPole_C : '<Root>/Discrete Zero-Pole'
                                        */
  6.9179101425685545E+001,             /* DiscreteZeroPole_D : '<Root>/Discrete Zero-Pole'
                                        */
  1.0,                                 /* InverseAmplifierGainVV_Gain_h : '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  10.0,                                /* DACBSaturationV_UpperSat_h : '<S6>/DACB Saturation (V)'
                                        */
  -10.0,                               /* DACBSaturationV_LowerSat_f : '<S6>/DACB Saturation (V)'
                                        */
  1.0,                                 /* AmplifierGainVV_Gain_k : '<S6>/Amplifier  Gain (V//V)'
                                        */
  24.0,                                /* AmplifierSaturationV_UpperSat_l : '<S6>/Amplifier  Saturation (V)'
                                        */
  -24.0,                               /* AmplifierSaturationV_LowerSat_p : '<S6>/Amplifier  Saturation (V)'
                                        */
  0.087266,                            /* StepAmplitude_Gain : '<Root>/Step Amplitude '
                                        */
  0.087266,                            /* StepAmplitude_Gain_g : '<Root>/Step Amplitude'
                                        */
