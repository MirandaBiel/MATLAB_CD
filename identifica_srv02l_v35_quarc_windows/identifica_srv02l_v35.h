 ...
 */
#ifndef RTW_HEADER_identifica_srv02l_v35_h_
#define RTW_HEADER_identifica_srv02l_v35_h_
#ifndef identifica_srv02l_v35_COMMON_INCLUDES_
# define identifica_srv02l_v35_COMMON_INCLUDES_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* identifica_srv02l_v35_COMMON_INCLUDES_ */

#include "identifica_srv02l_v35_types.h"
...
#define identifica_srv02l_v35_rtModel  RT_MODEL_identifica_srv02l_v35
...
typedef struct {
  ...
  real_T InverseAmplifierGainVV_f;     /* '<S6>/Inverse Amplifier  Gain (V//V)' */
  real_T DACBSaturationV_j;            /* '<S6>/DACB Saturation (V)' */
  real_T AmplifierGainVV_k;            /* '<S6>/Amplifier  Gain (V//V)' */
  real_T AmplifierSaturationV_b;       /* '<S6>/Amplifier  Saturation (V)' */
...
#define rtB                            identifica_srv02l_v35_B
#define BlockIO                        BlockIO_identifica_srv02l_v35
#define rtX                            identifica_srv02l_v35_X
#define ContinuousStates               ContinuousStates_identifica_srv
#define rtP                            identifica_srv02l_v35_P
#define Parameters                     Parameters_identifica_srv02l_v3
#define rtDWork                        identifica_srv02l_v35_DWork
#define D_Work                         D_Work_identifica_srv02l_v35

/* Parameters (auto storage) */
struct Parameters_identifica_srv02l_v3_ {
  ...
  real_T InverseAmplifierGainVV_Gain_i;/* Expression: 1/K_AMP
                                        ...
                                        */
  real_T DACBSaturationV_UpperSat_d;   /* Expression: VMAX_DAC
                                        * '<S6>/DACB Saturation (V)'
                                        */
  real_T DACBSaturationV_LowerSat_b;   /* Expression: -VMAX_DAC
                                        * '<S6>/DACB Saturation (V)'
                                        */
  real_T AmplifierGainVV_Gain_c;       /* Expression: K_AMP
                                        * '<S6>/Amplifier  Gain (V//V)'
                                        */
  real_T AmplifierSaturationV_UpperSat_d;/* Expression: VMAX_AMP
                                          * '<S6>/Amplifier  Saturation (V)'
                                          */
  real_T AmplifierSaturationV_LowerSat_m;/* Expression: -VMAX_AMP
                                          * '<S6>/Amplifier  Saturation (V)'
                                          */
...
struct RT_MODEL_identifica_srv02l_v35 {
  const char_T *path;
...
extern Parameters_identifica_srv02l_v3 identifica_srv02l_v35_P;

/* Block signals (auto storage) */
extern BlockIO_identifica_srv02l_v35 identifica_srv02l_v35_B;

/* Continuous states (auto storage) */
extern ContinuousStates_identifica_srv identifica_srv02l_v35_X;

/* Block states (auto storage) */
extern D_Work_identifica_srv02l_v35 identifica_srv02l_v35_DWork;
...
extern void identifica_srv02l_v35_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void identifica_srv02l_v35_initialize(boolean_T firstTime);
extern void identifica_srv02l_v35_output(int_T tid);
extern void identifica_srv02l_v35_update(int_T tid);
extern void identifica_srv02l_v35_output0(int_T tid);
extern void identifica_srv02l_v35_terminate(void);

/* Real-time Model object */
extern RT_MODEL_identifica_srv02l_v35 *identifica_srv02l_v35_M;
 ...
 *
 * '<Root>' : identifica_srv02l_v35
 * '<S1>'   : identifica_srv02l_v35/Manual Switch 1
 * '<S2>'   : identifica_srv02l_v35/SRV02
 * '<S3>'   : identifica_srv02l_v35/SRV02 Modelo Experimental
 * '<S4>'   : identifica_srv02l_v35/SRV02/SRV02-ET
 * '<S5>'   : identifica_srv02l_v35/SRV02/SRV02-ET/Actuator Electrical  Dynamics
 * '<S6>'   : identifica_srv02l_v35/SRV02 Modelo Experimental/Actuator Dynamics
 */
#endif                                 /* RTW_HEADER_identifica_srv02l_v35_h_ */
