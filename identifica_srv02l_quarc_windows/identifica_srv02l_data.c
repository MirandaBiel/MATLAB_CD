...
Parameters_identifica_srv02l identifica_srv02l_P = {
  ...
  1.0,                                 /* SquareWave_Amplitude : '<Root>/Square Wave'
                                        */
  0.4,                                 /* SquareWave_Frequency : '<Root>/Square Wave'
                                        */
  ...
  0.0,                                 /* Integrator_IC : '<S3>/Integrator'
                                        */
  1.0,                                 /* InverseAmplifierGainVV_Gain_g : '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  10.0,                                /* DACBSaturationV_UpperSat_m : '<S6>/DACB Saturation (V)'
                                        */
  ...
  4.0,                                 /* StepAmplitude_Gain : '<Root>/Step Amplitude '
                                        */
  4.0,                                 /* StepAmplitude_Gain_h : '<Root>/Step Amplitude'
                                        */
