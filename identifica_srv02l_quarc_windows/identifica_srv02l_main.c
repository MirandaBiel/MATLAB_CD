...
typedef identifica_srv02l_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * identifica_srv02l(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(identifica_srv02l_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: identifica_srv02l -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
        ...
        if (result == 0) {
          result = hil_task_start
            (identifica_srv02l_DWork.HILReadAnalogTimebase_Task,
             identifica_srv02l_P.HILReadAnalogTimebase_Clock, 1000.0, -1)
            ;
          if (result == 0) {
            ...
            /* disarm the timebase */
            hil_task_stop(identifica_srv02l_DWork.HILReadAnalogTimebase_Task)
              ;
