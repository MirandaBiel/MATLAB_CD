...
#ifndef identifica_srv02l_COMMON_INCLUDES_
# define identifica_srv02l_COMMON_INCLUDES_
#include <float.h>
#include <math.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* identifica_srv02l_COMMON_INCLUDES_ */

#include "identifica_srv02l_types.h"
...
#define identifica_srv02l_rtModel      RT_MODEL_identifica_srv02l
...
typedef struct {
  ...
  real_T InverseAmplifierGainVV_o;     /* '<S6>/Inverse Amplifier  Gain (V//V)' */
...
#define rtB                            identifica_srv02l_B
#define BlockIO                        BlockIO_identifica_srv02l
#define rtX                            identifica_srv02l_X
#define ContinuousStates               ContinuousStates_identifica_srv
#define rtP                            identifica_srv02l_P
#define Parameters                     Parameters_identifica_srv02l
#define rtDWork                        identifica_srv02l_DWork
#define D_Work                         D_Work_identifica_srv02l

/* Parameters (auto storage) */
struct Parameters_identifica_srv02l_ {
  ...
  real_T SquareWave_Amplitude;         /* Expression: 1
                                        * '<Root>/Square Wave'
                                        */
  real_T SquareWave_Frequency;         /* Expression: 0.4
                                        * '<Root>/Square Wave'
                                        */
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        * '<S3>/Integrator'
                                        */
  real_T InverseAmplifierGainVV_Gain_g;/* Expression: 1/K_AMP
                                        * '<S6>/Inverse Amplifier  Gain (V//V)'
                                        */
  real_T DACBSaturationV_UpperSat_m;   /* Expression: VMAX_DAC
  ...
  real_T AmplifierGainVV_Gain_n;       /* Expression: K_AMP
                                        ...
                                        */
  real_T AmplifierSaturationV_UpperSat_n;/* Expression: VMAX_AMP
  ...
  real_T StepAmplitude_Gain;           /* Expression: 4
                                        * '<Root>/Step Amplitude '
                                        */
  real_T StepAmplitude_Gain_h;         /* Expression: 4
                                        * '<Root>/Step Amplitude'
                                        */
...
struct RT_MODEL_identifica_srv02l {
  const char_T *path;
...
extern Parameters_identifica_srv02l identifica_srv02l_P;

/* Block signals (auto storage) */
extern BlockIO_identifica_srv02l identifica_srv02l_B;

/* Continuous states (auto storage) */
extern ContinuousStates_identifica_srv identifica_srv02l_X;

/* Block states (auto storage) */
extern D_Work_identifica_srv02l identifica_srv02l_DWork;
...
extern void identifica_srv02l_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void identifica_srv02l_initialize(boolean_T firstTime);
extern void identifica_srv02l_output(int_T tid);
extern void identifica_srv02l_update(int_T tid);
extern void identifica_srv02l_output0(int_T tid);
extern void identifica_srv02l_terminate(void);

/* Real-time Model object */
extern RT_MODEL_identifica_srv02l *identifica_srv02l_M;
 ...
 *
 * '<Root>' : identifica_srv02l
 * '<S1>'   : identifica_srv02l/Manual Switch 1
 * '<S2>'   : identifica_srv02l/SRV02
 * '<S3>'   : identifica_srv02l/SRV02 Modelo Experimental
 * '<S4>'   : identifica_srv02l/SRV02/SRV02-ET
 * '<S5>'   : identifica_srv02l/SRV02/SRV02-ET/Actuator Electrical  Dynamics
 * '<S6>'   : identifica_srv02l/SRV02 Modelo Experimental/Actuator Dynamics
 */
#endif                                 /* RTW_HEADER_identifica_srv02l_h_ */
